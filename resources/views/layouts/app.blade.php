    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="{{ route('dashboard.index') }}"><i class="fas fa-clinic-medical"></i>
                    DBS Medicenc System</a>
            </div>
            <ul class="nav navbar-nav">
                ...
                @permission('patient.index')
                    <li class="dropdown {{ request()->is('patient*') || request()->is('appointment*') ? 'active' : '' }}">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                            aria-expanded="false"> <i class="fas fa-hospital-user"></i> Students <span
                                class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="{{ route('patient.index') }}"> Student</a></li>
                ...
                @permission('invoice.report')
                    <li class="dropdown {{ request()->is('account/*') ? 'active' : '' }}">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                            aria-haspopup="true" aria-expanded="false"><i class="fas fa-file-medical-alt"></i> Report
                ...
                <li
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                        aria-haspopup="true" aria-expanded="false"><i class="fas fa-receipt"></i> Invoice/Bill <span
                            class="caret"></span></a>
                    <ul class="dropdown-menu">
                ...
                @permission('test.index')
                    <li
                        class="dropdown {{ request()->is('test') || request()->is('reference') || request()->is('haematology') || request()->is('biochemistry') || request()->is('immunology') || request()->is('microbiology') || request()->is('examination') || request()->is('stain') || request()->is('report') ? 'active' : '' }}">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                            aria-haspopup="true" aria-expanded="false"><i class="fas fa-flask"></i> Lab Test <span
                                class="caret"></span></a>
                        <ul class="dropdown-menu">
                ...
                @permission('hospital.setting')
                    <li
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                            aria-haspopup="true" aria-expanded="false"><i class="fas fa-tools"></i> Setting<span
                                class="caret"></span></a>
                        <ul class="dropdown-menu">
